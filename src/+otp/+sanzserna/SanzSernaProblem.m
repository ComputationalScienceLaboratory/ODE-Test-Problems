    ...
    methods (Access=protected)
        ...
        function onSettingsChanged(obj)
            ...
            obj.Rhs = otp.Rhs(@(t, y) otp.sanzserna.f(t, y, D, x), ...
                'Jacobian', otp.sanzserna.jac(D, x), ...
                'JacobianVectorProduct', @(t, y, v) otp.sanzserna.jvp(t, y, v, D, x), ...
                'PartialDerivativeTime', @(t, y) otp.sanzserna.pdt(t, y, D, x), ...
                'Vectorized', 'on');
            
            obj.RhsLinear = otp.Rhs(@(t, y) otp.sanzserna.flinear(t, y, D, x), ...
                'Jacobian', otp.sanzserna.jaclinear(D, x), ...
                'Vectorized', 'on');
            obj.RhsForcing = otp.Rhs(@(t, y) otp.sanzserna.fforcing(t, y, D, x), ...
                'Jacobian', otp.sanzserna.jacforcing(D, x), ...
                'Vectorized', 'on');
        end
