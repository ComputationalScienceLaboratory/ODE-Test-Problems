function Jvp = jacobianVectorProduct(~, y, v, mu, soft)
...
Jvpv = [dUdxdx.*v(1, :) + dUdxdy.*v(2, :) + dUdxdz.*v(3, :) + 2*v(5, :); ...
    dUdxdy.*v(1, :) + dUdydy.*v(2, :) + dUdydz.*v(3, :) - 2*v(4, :); ...
    dUdxdz.*v(1, :) + dUdydz.*v(2, :) + dUdzdz.*v(3, :)];
Jvp = [v(4:6, :); Jvpv];
